...
export function ArticleList({ articles, onEdit, onDelete }: Props) {
  if (articles.length === 0) {
    return (
      <div className="relative overflow-hidden rounded-3xl border border-dashed border-white/15 bg-zinc-900/50 px-8 py-16 text-center">
        ...
        <p className="relative m-0 font-display text-xl font-semibold text-white">No articles yet</p>
        <p className="relative mt-2 mb-0 mx-auto max-w-md text-sm leading-relaxed text-zinc-500">
          When stories are published for your campus, they will show up here with cover images and categories.
        </p>
      </div>
    );
  }
